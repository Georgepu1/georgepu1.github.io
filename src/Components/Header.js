         ...
         <div className="banner-text">
            ...
            <h3>
               <ul>
                  ...
                  <li style={{padding: '3px'}}>📝 Publishing utility patents on <a href="https://patents.justia.com/patent/20210042662" target="_blank" rel="noopener noreferrer"style={{ fontWeight: "bold" }}> Interactive Information Capture and Retrieval with prompt-based methods</a>, intelligent app navigation (draft), and dynamic search optimization (draft)</li>
