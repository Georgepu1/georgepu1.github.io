      ...
      <div className="row banner">
         <div className="banner-text">
            <h1 className="responsive-headline">
               <div>Hey! I'm {name}, and I'm</div>
            </h1>
            <h3>
               <ul>
                  <li>- a first year graduate CS student at <a href="https://www.ucla.edu/" target="_blank" rel="noopener noreferrer" style={{ fontWeight: "bold" }}>UCLA</a></li>
                  ...
                  <li>- actively doing ML/DL/NLP research (Past: <a href="https://shangjingbo1226.github.io/" target="_blank" rel="noopener noreferrer" style={{ fontWeight: "bold" }}>Prof. Jingbo Shang @ UCSD</a>)</li>
